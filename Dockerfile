...
CMD ["ttyd", "-p", "7860", "-W", "bash", "-c", "screen -wipe; screen -dmS session bash -l 2>/dev/null || true; exec screen -r session || exec screen -dmS session bash -l && exec screen -r session"]
